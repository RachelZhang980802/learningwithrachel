                  ...
                  <div className="modern-evidence-step">
                    ...
                    {modernStage === "roosevelt-explained" && (
                      <div className="muck-rake-click-reveal">
                        <p>Roosevelt accepted that exposing corruption could be indispensable to society. His warning concerned people who learned to look only at the muck.</p>
                        <div className="muck-rake-guiding-questions">
                          <p>Why might these people be “indispensable”?</p>
                          <p>What kind of “muck” are they uncovering?</p>
                        </div>
